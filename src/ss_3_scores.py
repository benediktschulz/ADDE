...
def main():
    ...
    # To evaluate
    sr_eval = ["crps", "logs", "lgt", "cov", "mae", "me", "rmse", "var_pit"]

    # Skill scores
    sr_skill = ["crps", "mae", "rmse"]
            ...
            for i_sim in range(temp_n_sim):
                ...
                if (temp_nn == nn_vec[0]) and optimal_score_available:
                    ...
                    for temp_sr in sr_eval:
                        ...
                        elif temp_sr == "var_pit":
                            new_row[temp_sr] = np.var(scores_opt["pit"])
                        else:
                ...
                for i_rep in range(n_rep):
                    ...
                    for temp_sr in sr_eval:
                        ...
                        if temp_sr == "mae":
                            ...
                            new_row[temp_sr] = np.var(pred_nn["scores"]["pit"])
                        else:
                            new_row[temp_sr] = np.mean(
                    ...
                    for i_ens in n_ens_vec:
                        ...
                        for temp_sr in sr_eval:
                            ...
                            if temp_sr == "mae":
                                ...
                                new_row[temp_sr] = np.var(pred_agg["scores"]["pit"])
                            else:
                                new_row[temp_sr] = np.mean(
                        ...
                        for temp_sr in sr_skill:
                            ...
                            s_ref = df_scores[
                                ...
                                & (df_scores["type"] == "ind")
                                & (df_scores["n_rep"] < i_ens) # n_rep starts at 0!!
                            ][temp_sr].mean()
                            ...
                            new_row[f"{temp_sr}s"] = temp_entry
